...
# PORTABILITY: ONE L1 distro per run (arg 1, default fedora44). An ubuntu L1 is a SECOND
# operator-run invocation (`DRVPS_LIVE=1 tests/dogfood/nested-selftest.sh ubuntu26`); a single
# PASS line never implies multi-distro coverage.
#
